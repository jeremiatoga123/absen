							...
							<tbody>
								...
								<td align="center">
									<div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
										<a href="page.php?s-detail-siswa&id=<?php echo $data['id_siswa'];?>" class="btn btn btn-default" data-toggle="tooltip" data-placement="top" title="Detail?"><i class="font-icon font-icon-eye"></i> </a>
									</div>
								</td>
								</tr>
	 							<?php 
					...
					<div class="col-md-6" align="right">
						<nav>
							<ul class="pagination">
								...
								<a class='page-link' href='page.php?s-data-siswa&kelas=$nm_kelas&pg=$link' aria-label='Previous'>
								...
								$nmr.= "<li class='page-item'><a class='page-link' href='page.php?s-data-siswa&kelas=$nm_kelas&pg=$i'>$i</a></li>";
								}
								}
								...
								<a class='page-link' href='page.php?s-data-siswa&kelas=$nm_kelas&pg=$link'aria-label='Next'>
